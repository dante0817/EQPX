...
uses Classes, System.StrUtils, IOUtils, SysUtils;
...
//  Ml := StrToFloat(frmMain.sgMainData.Cells[10, 0]);
  Ml := StrToFloat(frmMain.ledMagnitude.Text);
...
//------------------
    ...
    begin
      sta := Trim(frmMain.sgMainData.Cells[0, i]);  // get the value from sgAtlasPick
